...
const Globe: FC = ({ children }) => {
  return (
    <div className="relative bg-custom-offwhite rounded-full overflow-hidden border-solid border-8 border-custom w-72 h-72 sm:w-80 sm:h-80 lg:w-96 lg:h-96">
      <svg
