...
export const Globe: FC<GlobeType> = ({ zIndex, fill1, fill2, children }) => {
  return (
    <div
      className={`${zIndex} relative bg-custom-offwhite rounded-full overflow-hidden border-solid border-8 border-custom w-60 h-60 sm:w-80 sm:h-80 lg:w-96 lg:h-96 flex`}
